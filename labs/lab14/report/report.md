...
author: Оширова Юлия, НКАбд-02-22
...
![Текст программы](image/s1){#fig:001 width=70%}
...
![Текст программы](image/s2){#fig:002 width=70%}
...
[1. Лабораторная работа № 14. Именованные каналы [Электронный ресурс]](https://esystem.rudn.ru/)
